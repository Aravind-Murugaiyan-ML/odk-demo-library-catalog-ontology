...
setup-ssh:
	...
	@eval "$$(ssh-agent -s)" && ssh-add ~/.ssh/mak-aravind-maplelabs-id25519
...
setup-remote:
	...
	@git remote set-url origin git@github-Aravind-Murugaiyan-ML:Aravind-Murugaiyan-ML/odk-demo-library-catalog-ontology.git
